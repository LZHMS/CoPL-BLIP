...
class DPL(TrainerX):
    ...
    def eval_train(self):
        ...
        # estimate_noise_rate = sum(noisy_labels != predict_labels) / data_len
        # if estimate_noise_rate <= 0.5:
        #     std_clean += (std_clean + std_noise) * 3 / 2
        #     std_noise += (std_clean + std_noise) * 3 / 2
