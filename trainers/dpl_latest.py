...
class BLIPPromptLearner(nn.Module):
    def __init__(self, cfg, classnames, blip_model, features):
        ...
        n_cls = len(classnames)
        n_ctx = cfg.TRAINER.DPL.N_CTX
        ctx_init = "a photo of a" # .join(["X"] * n_ctx) #cfg.TRAINER.DPL.CTX_INIT
        n_ctx = len(ctx_init.split(" "))
...
class DPL(TrainerX):
    def __init__(self, cfg):
        ...
        self.beta1 = cfg.TRAINER.DPL.BETA1
        self.beta2 = cfg.TRAINER.DPL.BETA2
        self.alpha = cfg.TRAINER.DPL.ALPHA
    ...
    def build_model(self):
        ...
        self.scalerD = GradScaler() if cfg.TRAINER.DPL.PREC == "amp" else None
